    ...
    <View style={styles.container}>
      ...
      <View style={styles.qrCard}>
        <View style={styles.qrBox}>
          <QRCode value={qrValue} size={200} color={brand.primary} />
        </View>
      ...
      <View style={styles.tipCard}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.tipBody}>
            Print this QR code on your event flyers or banners, or share it on
            social media so guests can quickly access event details.
          </Text>
        </View>
      </View>
    </View>
